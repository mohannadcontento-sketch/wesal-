...
// Re-export data from server-safe module so existing imports work
export { AVATARS, CATEGORY_LABELS, isBuiltInAvatar, type AvatarOption } from './avatar-ids';

// Re-export isValidAvatarId for server-side use
export { isValidAvatarId } from './avatar-ids';
...
/* ── Render helper: get React element for an avatar id ── */
export function renderAvatarSvg(avatarId: string): React.ReactNode | null {
  const SvgComponent = avatarSvgs[avatarId];
